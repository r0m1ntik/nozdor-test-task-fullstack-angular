...
- Приложение на **Angular v20** (желательно с **Signals**) и **TypeScript strict**.
...
- Angular v20, Standalone Components, **Signals** (например, `signal()` для состояния персонажа и выбранного слота).
...
## 9) Ожидаемая структура репозитория (пример)
...
Удачи! Если чего-то не хватает в описании — делайте разумные допущения и отражайте их в README. Работы не будут использоваться на нашем проекте без вашего согласия.
